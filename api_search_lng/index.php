...
// Ruud 08-02-16: change default sort order = field51 (= original file name), asc
//$order_by=getvalescaped("order_by","relevance");
$order_by=getvalescaped("order_by","field51");
...
// Ruud 03-02-16: add alt file to response; copied from api_alt_file plugin
...
if (getval("content","")=="xml" && !$paginate){
    ...
    // Ruud 08-02-16: add more information to json output! E.g. total missing from original output.
    // Haven't bothered to update xml output as we're not using that anyway.
    ...
    echo json_encode($output); // echo json without headers by default
}
